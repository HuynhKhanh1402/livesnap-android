        ...
        AnimatedVisibility(
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    supportingText = {
                        AnimatedVisibility(
                            visible = !viewModel.isEmailValid || viewModel.isEmailNonExist,
                            enter = fadeIn() + expandVertically(),
                            exit = fadeOut() + shrinkVertically()
                        ) {
                            Text(
                                text = when {
                                    !viewModel.isEmailValid -> stringResource(R.string.invalid_email_format)
                                    viewModel.isEmailNonExist -> "Email does not exist. Please register first."
                                    else -> ""
                                },
                    ...
                    leadingIcon = {
                        Icon(
                            ...
                            contentDescription = null,
                            tint = if (!viewModel.isEmailValid || viewModel.isEmailNonExist)
